...
static gboolean vala_slice_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp8_ = vala_slice_expression_get_container (self);
	_tmp9_ = _tmp8_;
	_tmp10_ = vala_expression_get_value_type (_tmp9_);
	_tmp11_ = _tmp10_;
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp11_, VALA_TYPE_ARRAY_TYPE)) {
		...
		_tmp12_ = vala_slice_expression_get_start (self);
		_tmp13_ = _tmp12_;
		_tmp14_ = context;
		...
		_tmp19_ = _tmp18_;
		vala_expression_set_target_type (_tmp13_, _tmp19_);
		_vala_code_node_unref0 (_tmp19_);
		_tmp20_ = vala_slice_expression_get_stop (self);
		_tmp21_ = _tmp20_;
		_tmp22_ = context;
		_tmp23_ = vala_code_context_get_analyzer (_tmp22_);
		_tmp24_ = _tmp23_;
		_tmp25_ = _tmp24_->int_type;
		_tmp26_ = vala_data_type_copy (_tmp25_);
		_tmp27_ = _tmp26_;
		vala_expression_set_target_type (_tmp21_, _tmp27_);
		_vala_code_node_unref0 (_tmp27_);
	}
	_tmp28_ = vala_slice_expression_get_start (self);
	_tmp29_ = _tmp28_;
	_tmp30_ = context;
	_tmp31_ = vala_code_node_check ((ValaCodeNode*) _tmp29_, _tmp30_);
	if (!_tmp31_) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
		return result;
	}
	_tmp32_ = vala_slice_expression_get_stop (self);
	_tmp33_ = _tmp32_;
	_tmp34_ = context;
	_tmp35_ = vala_code_node_check ((ValaCodeNode*) _tmp33_, _tmp34_);
	if (!_tmp35_) {
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		result = FALSE;
		return result;
	...
	if (_tmp39_ == NULL) {
		...
		vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
		_tmp40_ = vala_slice_expression_get_container (self);
		_tmp41_ = _tmp40_;
		_tmp42_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp41_);
		_tmp43_ = _tmp42_;
		vala_report_error (_tmp43_, "Invalid container expression");
		result = FALSE;
		return result;
	}
	_tmp44_ = vala_expression_get_lvalue ((ValaExpression*) self);
	_tmp45_ = _tmp44_;
	if (_tmp45_) {
		...
		_tmp49_ = _tmp48_;
		vala_report_error (_tmp49_, "Slice expressions cannot be used as lvalue");
		result = FALSE;
		return result;
	}
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp53_, VALA_TYPE_ARRAY_TYPE)) {
		...
		gboolean _tmp85_;
		_tmp54_ = vala_slice_expression_get_container (self);
		_tmp55_ = _tmp54_;
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp66_, VALA_TYPE_INTEGER_TYPE)) {
			...
			_tmp67_ = vala_slice_expression_get_start (self);
			_tmp68_ = _tmp67_;
			_tmp69_ = vala_expression_get_value_type (_tmp68_);
			_tmp70_ = _tmp69_;
			_tmp62_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp70_, VALA_TYPE_ENUM_VALUE_TYPE);
		}
		_tmp71_ = _tmp62_;
		if (!_tmp71_) {
			...
			vala_code_node_set_error ((ValaCodeNode*) self, TRUE);
			_tmp72_ = vala_slice_expression_get_start (self);
			_tmp73_ = _tmp72_;
			_tmp74_ = vala_code_node_get_source_reference ((ValaCodeNode*) _tmp73_);
			_tmp75_ = _tmp74_;
			vala_report_error (_tmp75_, "Expression of integer type expected");
		}
		_tmp77_ = vala_slice_expression_get_stop (self);
		_tmp78_ = _tmp77_;
		_tmp79_ = vala_expression_get_value_type (_tmp78_);
		_tmp80_ = _tmp79_;
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp80_, VALA_TYPE_INTEGER_TYPE)) {
			_tmp76_ = TRUE;
		} else {
			...
			_tmp81_ = vala_slice_expression_get_stop (self);
			_tmp82_ = _tmp81_;
			_tmp83_ = vala_expression_get_value_type (_tmp82_);
			_tmp84_ = _tmp83_;
			_tmp76_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp84_, VALA_TYPE_ENUM_VALUE_TYPE);
		}
		_tmp85_ = _tmp76_;
		if (!_tmp85_) {
			...
			_tmp89_ = _tmp88_;
			vala_report_error (_tmp89_, "Expression of integer type expected");
		}
	} else {
		...
		gchar* _tmp126_ = NULL;
		gchar* _tmp127_;
		_tmp90_ = vala_slice_expression_get_container (self);
		_tmp91_ = _tmp90_;
		_tmp92_ = vala_expression_get_value_type (_tmp91_);
		_tmp93_ = _tmp92_;
		_tmp94_ = vala_data_type_get_member (_tmp93_, "slice");
		_tmp95_ = G_TYPE_CHECK_INSTANCE_TYPE (_tmp94_, VALA_TYPE_METHOD) ? ((ValaMethod*) _tmp94_) : NULL;
		if (_tmp95_ == NULL) {
			_vala_code_node_unref0 (_tmp94_);
		}
		slice_method = _tmp95_;
		_tmp96_ = slice_method;
		if (_tmp96_ != NULL) {
			...
			ValaCodeNode* _tmp112_;
			ValaCodeNode* _tmp113_;
			ValaMethodCall* _tmp114_;
			ValaMethodCall* _tmp115_;
			ValaCodeContext* _tmp116_;
			gboolean _tmp117_ = FALSE;
			_tmp97_ = vala_slice_expression_get_container (self);
			_tmp98_ = _tmp97_;
			_tmp99_ = vala_member_access_new (_tmp98_, "slice", NULL);
			_tmp100_ = _tmp99_;
			_tmp101_ = vala_method_call_new ((ValaExpression*) _tmp100_, NULL);
			_tmp102_ = _tmp101_;
			_vala_code_node_unref0 (_tmp100_);
			slice_call = _tmp102_;
			_tmp103_ = slice_call;
			_tmp104_ = vala_slice_expression_get_start (self);
			_tmp105_ = _tmp104_;
			vala_method_call_add_argument (_tmp103_, _tmp105_);
			_tmp106_ = slice_call;
			_tmp107_ = vala_slice_expression_get_stop (self);
			_tmp108_ = _tmp107_;
			vala_method_call_add_argument (_tmp106_, _tmp108_);
			_tmp109_ = slice_call;
			_tmp110_ = vala_expression_get_target_type ((ValaExpression*) self);
			_tmp111_ = _tmp110_;
			vala_expression_set_target_type ((ValaExpression*) _tmp109_, _tmp111_);
			_tmp112_ = vala_code_node_get_parent_node ((ValaCodeNode*) self);
			_tmp113_ = _tmp112_;
			_tmp114_ = slice_call;
			vala_code_node_replace_expression (_tmp113_, (ValaExpression*) self, (ValaExpression*) _tmp114_);
			_tmp115_ = slice_call;
			_tmp116_ = context;
			_tmp117_ = vala_code_node_check ((ValaCodeNode*) _tmp115_, _tmp116_);
			result = _tmp117_;
		...
		_tmp119_ = _tmp118_;
		_tmp120_ = vala_slice_expression_get_container (self);
		_tmp121_ = _tmp120_;
		_tmp122_ = vala_expression_get_value_type (_tmp121_);
		_tmp123_ = _tmp122_;
		_tmp124_ = vala_code_node_to_string ((ValaCodeNode*) _tmp123_);
		_tmp125_ = _tmp124_;
		_tmp126_ = g_strdup_printf ("The expression `%s' does not denote an array", _tmp125_);
		_tmp127_ = _tmp126_;
		vala_report_error (_tmp119_, _tmp127_);
		_g_free0 (_tmp127_);
		_g_free0 (_tmp125_);
		_vala_code_node_unref0 (slice_method);
	}
