...
static void vala_gir_parser_parse_function (ValaGirParser* self, const gchar* element_name) {
	...
	GEqualFunc _tmp243_;
	ValaArrayList* _tmp244_;
	gboolean _tmp245_ = FALSE;
	ValaMarkupTokenType _tmp246_;
	gboolean _tmp250_;
	...
	if (_tmp178_) {
		...
		if (_tmp180_) {
			...
			if (g_strcmp0 (_tmp196_, "1") == 0) {
				ValaSymbol* _tmp197_;
				ValaErrorType* _tmp198_;
				ValaErrorType* _tmp199_;
				_tmp197_ = s;
	...
	if (_tmp250_) {
		...
		vala_gir_parser_next (self);
		while (TRUE) {
			ValaMarkupTokenType _tmp251_;
			ValaMarkupReader* _tmp252_;
			...
			if (_tmp306_) {
				...
				if (_tmp312_ != NULL) {
					ValaUnresolvedType* _tmp313_;
					ValaUnresolvedSymbol* _tmp314_;
					ValaUnresolvedSymbol* _tmp315_;
				...
				if (_tmp318_) {
					ValaSymbol* _tmp319_;
					ValaGirParserParameterInfo* _tmp320_;
					_tmp319_ = s;
			...
			while (TRUE) {
				...
				if (_tmp345_) {
					...
					if (g_strcmp0 (_tmp351_, "Gio.Cancellable?") == 0) {
						...
						ValaNullLiteral* _tmp354_;
						ValaNullLiteral* _tmp355_;
						_tmp352_ = pi;
	...
	_tmp359_ = _tmp356_;
	if (_tmp359_) {
		ValaGirParserMetadata* _tmp360_;
		...
		if (_tmp361_) {
			ValaGirParserMetadata* _tmp362_;
			gint _tmp363_ = 0;
			gint instance_pos;
			ValaSymbol* _tmp364_;
			gint _tmp365_;
...
static void vala_gir_parser_parse_boxed (ValaGirParser* self, const gchar* element_name) {
	...
	ValaGirComment* _tmp45_;
	ValaGirParserNode* ref_method;
	ValaGirParserNode* unref_method;
...
static void vala_gir_parser_process_callable (ValaGirParser* self, ValaGirParserNode* node) {
			...
			if (_tmp64_ == 1) {
				...
				if (_tmp73_ == VALA_PARAMETER_DIRECTION_OUT) {
					...
					if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp77_, VALA_TYPE_UNRESOLVED_TYPE)) {
						...
						_tmp93_ = _tmp89_;
						if (_tmp93_) {
							ValaGirParserParameterInfo* _tmp94_;
						...
						if (_tmp100_) {
							...
							ValaGirParserParameterInfo* _tmp102_;
							ValaParameter* _tmp103_;
	...
	if (_tmp146_ > 1) {
		...
		ValaGirParserParameterInfo* last_param;
		ValaGirParserParameterInfo* _tmp152_;
		...
		if (_tmp155_) {
			...
			if (_tmp165_) {
				ValaGirParserParameterInfo* _tmp166_;
	...
	last = -1;
	{
		...
		while (TRUE) {
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp179_, VALA_TYPE_DELEGATE)) {
				ValaGirParserParameterInfo* _tmp180_;
				gint _tmp181_;
				gint _tmp182_;
				_tmp180_ = info;
			...
			if (_tmp183_) {
				...
				if (_tmp209_) {
					...
					ValaGirParserParameterInfo* _tmp238_;
					ValaGirParserParameterInfo* _tmp239_;
					gint _tmp240_;
					gint _tmp241_;
					gint _tmp242_;
					_tmp238_ = info;
	...
	}
	{
		...
		while (TRUE) {
			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp257_, VALA_TYPE_METHOD)) {
				ValaSymbol* _tmp258_;
				ValaGirParserParameterInfo* _tmp259_;
			...
			if (_tmp270_ != (-1)) {
				ValaGirParserParameterInfo* _tmp271_;
				gint _tmp272_;
				ValaList* _tmp273_;
				gint _tmp274_;
				gint _tmp275_;
			...
			if (_tmp346_) {
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp352_, VALA_TYPE_UNRESOLVED_TYPE)) {
					...
					ValaUnresolvedSymbol* _tmp356_;
					ValaUnresolvedSymbol* _tmp357_;
					ValaSymbol* _tmp358_ = NULL;
					ValaSymbol* resolved_symbol;
					ValaSymbol* _tmp359_;
					_tmp353_ = node;
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp362_, VALA_TYPE_DELEGATE_TYPE)) {
					...
					_tmp376_ = _tmp367_;
					if (!_tmp376_) {
						ValaGirParserParameterInfo* _tmp377_;
...
static void vala_gir_parser_node_process (ValaGirParserNode* self, ValaGirParser* parser) {
	...
	if (_tmp101_ != NULL) {
		...
		ValaGirParserMetadata* _tmp724_;
		...
		if (_tmp715_) {
			ValaGirParserMetadata* _tmp716_;
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp728_, VALA_TYPE_NAMESPACE)) {
			...
			ValaGirParserMetadata* _tmp732_;
	...
	if (_tmp790_) {
		...
		gboolean _tmp827_;
		{
			ValaArrayList* _tmp791_;
			ValaArrayList* _tmp792_;
			ValaArrayList* _node_list;
			ValaArrayList* _tmp793_;
			gint _tmp794_;
			gint _tmp795_;
			gint _node_size;
			gint _node_index;
