			...
			if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp13_, VALA_TYPE_INTERFACE)) {
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp29_, VALA_TYPE_METHOD)) {
					...
					if (_tmp37_) {
						...
						_tmp51_ = base_method;
						self->priv->_base_interface_method = _tmp51_;
						_g_free0 (invalid_match);
						_vala_code_node_unref0 (base_method);
						_vala_code_node_unref0 (sym);
						_vala_code_node_unref0 (type);
...
"t", _tmp310_);
		...
		if (_tmp317_) {
			...
			_tmp331_ = _tmp325_;
			if (_tmp331_) {
				ValaSymbolAccessibility _tmp332_;
				ValaSymbolAccessibility _tmp333_;
...
"tentional", _tmp365_, _tmp369_);
	...
	if (_tmp482_) {
		ValaCodeContext* _tmp483_;
		ValaMethod* _tmp484_;
		ValaMethod* _tmp485_;
		ValaCodeContext* _tmp495_;
		gboolean _tmp496_;
		gboolean _tmp497_;
		_tmp483_ = context;
