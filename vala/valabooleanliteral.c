...
static void vala_boolean_literal_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	_tmp0_ = visitor;
	vala_code_visitor_visit_boolean_literal (_tmp0_, self);
	_tmp1_ = visitor;
...
static gboolean vala_boolean_literal_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	_tmp6_ = _tmp5_;
	_tmp7_ = _tmp6_->bool_type;
	vala_expression_set_value_type ((ValaExpression*) self, _tmp7_);
...
static void vala_boolean_literal_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	_tmp0_ = codegen;
	vala_code_visitor_visit_boolean_literal ((ValaCodeVisitor*) _tmp0_, self);
	_tmp1_ = codegen;
