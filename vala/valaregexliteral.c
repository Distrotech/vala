...
enum  {
	VALA_REGEX_LITERAL_DUMMY_PROPERTY
};
...
ValaRegexLiteral* vala_regex_literal_construct (GType object_type, const gchar* value, ValaSourceReference* source_reference) {
	...
	_tmp0_ = value;
	vala_regex_literal_set_value (self, _tmp0_);
...
static void vala_regex_literal_real_accept (ValaCodeNode* base, ValaCodeVisitor* visitor) {
	...
	_tmp0_ = visitor;
	vala_code_visitor_visit_regex_literal (_tmp0_, self);
	_tmp1_ = visitor;
...
static void vala_regex_literal_real_emit (ValaCodeNode* base, ValaCodeGenerator* codegen) {
	...
	_tmp0_ = codegen;
	vala_code_visitor_visit_regex_literal ((ValaCodeVisitor*) _tmp0_, self);
	_tmp1_ = codegen;
...
static void vala_regex_literal_instance_init (ValaRegexLiteral * self) {
