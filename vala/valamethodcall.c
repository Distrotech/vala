...
static gboolean vala_method_call_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp808_, VALA_TYPE_METHOD_TYPE)) {
		...
		_tmp895_ = _tmp890_;
		if (_tmp895_) {
			ValaDynamicSignal* _tmp896_;
			ValaDynamicSignal* _tmp897_;
			...
			gboolean first;
			ValaDynamicSignal* _tmp926_;
			ValaExpression* _tmp927_;
			ValaExpression* _tmp928_;
			ValaDynamicSignal* _tmp929_;
			ValaDynamicSignal* _tmp930_;
			ValaSymbol* _tmp931_;
			ValaSymbol* _tmp932_;
			ValaObjectType* _tmp933_;
			ValaObjectType* _tmp934_;
			ValaDelegate* _tmp935_ = NULL;
			ValaDelegate* _tmp936_;
			ValaDelegateType* _tmp937_;
			ValaDelegateType* _tmp938_;
		...
		if (_tmp946_) {
			...
			ValaMemberAccess* _tmp949_;
			ValaMemberAccess* ma;
			ValaMemberAccess* _tmp950_;
						...
						arg_it = _tmp968_;
						{
							...
							while (TRUE) {
								...
								if (_tmp989_) {
									...
									if (_tmp997_ != NULL) {
										ValaGenericType* _tmp998_;
										ValaTypeParameter* _tmp999_;
										ValaTypeParameter* _tmp1000_;
										ValaTypeParameter* _tmp1001_;
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1089_, VALA_TYPE_OBJECT_TYPE)) {
			...
			ValaClass* cl;
			ValaClass* _tmp1094_;
			ValaCreationMethod* _tmp1095_;
			ValaCreationMethod* _tmp1096_;
			ValaCreationMethod* _tmp1097_;
	...
	if (_tmp1160_) {
		...
		if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp1169_, VALA_TYPE_STRUCT_VALUE_TYPE)) {
			...
			ValaTypeSymbol* _tmp1173_;
			ValaTypeSymbol* _tmp1174_;
			ValaCodeContext* _tmp1175_;
	...
	if (_tmp1182_) {
		...
		if (_tmp1188_) {
			...
			if (!G_TYPE_CHECK_INSTANCE_TYPE (_tmp1193_, VALA_TYPE_BLOCK)) {
				...
				ValaDeclarationStatement* _tmp1211_;
				ValaDeclarationStatement* decl;
				ValaCodeContext* _tmp1212_;
				ValaSemanticAnalyzer* _tmp1213_;
				ValaSemanticAnalyzer* _tmp1214_;
				ValaBlock* _tmp1215_;
				ValaDeclarationStatement* _tmp1216_;
				...
				ValaDeclarationStatement* _tmp1227_;
				ValaCodeContext* _tmp1228_;
				ValaExpression* _tmp1229_;
				ValaCodeContext* _tmp1230_;
				ValaCodeContext* _tmp1231_;
				...
				ValaBlock* block;
				ValaBlock* _tmp1237_;
				ValaLocalVariable* _tmp1238_;
				ValaCodeContext* _tmp1239_;
				ValaSemanticAnalyzer* _tmp1240_;
				ValaSemanticAnalyzer* _tmp1241_;
				ValaBlock* _tmp1242_;
