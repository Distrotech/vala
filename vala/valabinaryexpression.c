		...
		if (_tmp369_) {
			...
			if (_tmp412_) {
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp416_, VALA_TYPE_POINTER_TYPE)) {
					...
					ValaPointerType* _tmp421_;
					ValaPointerType* pointer_type;
					ValaPointerType* _tmp422_;
									...
									if (_tmp819_ == VALA_BINARY_OPERATOR_IN) {
										...
										if (_tmp839_) {
											...
											if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp851_, VALA_TYPE_ARRAY_TYPE)) {
												...
												ValaMemberAccess* _tmp928_;
												ValaMemberAccess* _tmp929_;
												ValaSourceReference* _tmp930_;
												ValaSourceReference* _tmp931_;
												ValaMethodCall* _tmp932_;
												ValaMethodCall* _tmp933_;
												ValaMethodCall* contains_call;
												ValaMethodCall* _tmp934_;
												ValaExpression* _tmp935_;
												ValaExpression* _tmp936_;
												ValaCodeNode* _tmp937_;
												ValaCodeNode* _tmp938_;
												ValaMethodCall* _tmp939_;
												ValaMethodCall* _tmp940_;
												ValaCodeContext* _tmp941_;
