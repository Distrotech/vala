...
static gboolean vala_conditional_expression_real_check (ValaCodeNode* base, ValaCodeContext* context) {
	...
	ValaDeclarationStatement* _tmp165_;
	...
	ValaAssignment* _tmp215_;
	ValaAssignment* _tmp216_;
	...
	ValaBlock* _tmp228_;
	ValaDeclarationStatement* _tmp229_;
