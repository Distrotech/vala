...
static void vala_gobject_module_real_generate_class_init (ValaGTypeModule* base, ValaClass* cl) {
	...
	}
	{
		...
		while (TRUE) {
			...
			ValaCCodeEnum* _tmp167_;
			const gchar* _tmp168_;
			ValaCCodeEnumValue* _tmp169_;
			ValaCCodeEnumValue* _tmp170_;
			...
			ValaTypeParameter* _tmp224_;
			const gchar* _tmp225_;
			const gchar* _tmp226_;
			gchar* _tmp227_ = NULL;
			gchar* _tmp228_;
			gchar* _tmp229_ = NULL;
			ValaTypeParameter* _tmp230_;
			...
			ValaCCodeEnum* _tmp273_;
			const gchar* _tmp274_;
			ValaCCodeEnumValue* _tmp275_;
			ValaCCodeEnumValue* _tmp276_;
	...
	props = _tmp278_;
	{
		...
		while (TRUE) {
			...
			if (_tmp294_ != NULL) {
				...
				ValaComment* _tmp298_;
				ValaComment* _tmp299_;
				const gchar* _tmp300_;
				const gchar* _tmp301_;
				ValaCCodeComment* _tmp302_;
				ValaCCodeComment* _tmp303_;
...
static void vala_gobject_module_real_visit_constructor (ValaCodeVisitor* base, ValaConstructor* c) {
	...
	if (_tmp9_ == VALA_MEMBER_BINDING_INSTANCE) {
		...
		if (_tmp122_ == VALA_MEMBER_BINDING_CLASS) {
			...
			gboolean _tmp124_;
			gboolean _tmp125_;
			ValaCCodeBaseModuleEmitContext* _tmp130_;
...
static gchar* vala_gobject_module_real_get_dynamic_property_getter_cname (ValaCCodeBaseModule* base, ValaDynamicProperty* prop) {
	...
	ValaDynamicProperty* _tmp1_;
	ValaDataType* _tmp2_;
	ValaDataType* _tmp3_;
	ValaTypeSymbol* _tmp4_;
	ValaTypeSymbol* _tmp5_;
	gboolean _tmp13_;
	ValaDynamicProperty* _tmp16_;
	const gchar* _tmp17_;
	const gchar* _tmp18_;
	gint _tmp19_;
	gchar* _tmp20_ = NULL;
...
static gchar* vala_gobject_module_real_get_dynamic_signal_connect_wrapper_name (ValaCCodeBaseModule* base, ValaDynamicSignal* sig) {
	...
	gchar* result = NULL;
	gboolean _tmp0_ = FALSE;
	ValaDynamicSignal* _tmp1_;
	ValaDataType* _tmp2_;
	ValaDataType* _tmp3_;
	ValaTypeSymbol* _tmp4_;
	ValaTypeSymbol* _tmp5_;
	gboolean _tmp13_;
	ValaDynamicSignal* _tmp16_;
	gchar* _tmp17_ = NULL;
	gchar* _tmp18_;
	gchar* _tmp19_ = NULL;
	gchar* _tmp20_;
...
static void vala_gobject_module_real_visit_method_call (ValaCodeVisitor* base, ValaMethodCall* expr) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp2_, VALA_TYPE_MEMBER_ACCESS)) {
		...
		if (_tmp30_) {
			...
			ValaCCodeConditionalExpression* _tmp54_;
			ValaCCodeConditionalExpression* cexpr;
			ValaMethodCall* _tmp55_;
			ValaMethodCall* _tmp56_;
			ValaDataType* _tmp57_;
			ValaDataType* _tmp58_;
			ValaCCodeConditionalExpression* _tmp59_;
