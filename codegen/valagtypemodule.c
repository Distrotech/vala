...
static void vala_gtype_module_real_generate_class_struct_declaration (ValaCCodeBaseModule* base, ValaClass* cl, ValaCCodeFile* decl_space) {
	...
	_tmp488_ = _tmp478_;
	if (_tmp488_) {
		ValaCCodeFile* _tmp489_;
		ValaCCodeStruct* _tmp490_;
		_tmp489_ = decl_space;
	...
	if (_tmp491_) {
		ValaCCodeFile* _tmp492_;
		ValaCCodeStruct* _tmp493_;
		_tmp492_ = decl_space;
...
static void vala_gtype_module_generate_class_private_declaration (ValaGTypeModule* self, ValaClass* cl, ValaCCodeFile* decl_space) {
		...
		while (TRUE) {
			...
			if (_tmp83_ == VALA_MEMBER_BINDING_INSTANCE) {
				...
				if (_tmp194_ == VALA_MEMBER_BINDING_CLASS) {
					ValaField* _tmp195_;
					ValaSymbolAccessibility _tmp196_;
	...
	if (_tmp254_) {
		...
		if (_tmp260_) {
			...
			ValaCCodeTypeDefinition* _tmp274_;
		...
		if (_tmp302_) {
			...
			ValaCCodeMacroReplacement* _tmp320_;
		...
		if (_tmp327_) {
			...
			ValaCCodeMacroReplacement* _tmp354_;
...
static void vala_gtype_module_add_interface_init_function (ValaGTypeModule* self, ValaClass* cl, ValaInterface* iface) {
	...
	}
	{
		...
		while (TRUE) {
			...
			ValaObjectTypeSymbol* _tmp302_;
			ValaInterface* _tmp303_;
		...
		while (TRUE) {
			...
			if (_tmp439_) {
				...
				if (_tmp459_ != NULL) {
					...
					gchar* _tmp482_ = NULL;
					gchar* _tmp483_;
					ValaCCodeMemberAccess* _tmp484_;
				...
				if (_tmp489_ != NULL) {
					...
					ValaCCodeMemberAccess* _tmp515_;
					ValaCCodeExpression* _tmp516_;
...
static ValaCCodeFunctionCall* vala_gtype_module_real_get_param_spec (ValaCCodeBaseModule* base, ValaProperty* prop) {
	...
	ValaCCodeConstant* _tmp477_;
	ValaCCodeConstant* _tmp478_;
	self = (ValaGTypeModule*) base;
	...
	if (_tmp452_ != NULL) {
		...
		ValaSymbolAccessibility _tmp456_;
		ValaSymbolAccessibility _tmp457_;
		_tmp453_ = prop;
...
static void vala_gtype_module_real_generate_interface_declaration (ValaCCodeBaseModule* base, ValaInterface* iface, ValaCCodeFile* decl_space) {
	...
	gboolean _tmp132_;
	ValaCCodeFile* _tmp375_;
	ValaCCodeStruct* _tmp376_;
	ValaInterface* _tmp377_;
	ValaCodeContext* _tmp378_;
	ValaCodeContext* _tmp379_;
	ValaInterfaceRegisterFunction* _tmp380_;
	ValaInterfaceRegisterFunction* type_fun;
	ValaInterfaceRegisterFunction* _tmp381_;
	gboolean _tmp382_;
	ValaCCodeFile* _tmp383_;
	ValaInterfaceRegisterFunction* _tmp384_;
	ValaCCodeFragment* _tmp385_ = NULL;
	ValaCCodeFragment* _tmp386_;
	self = (ValaGTypeModule*) base;
	g_return_if_fail (iface != NULL);
	g_return_if_fail (decl_space != NULL);
	_tmp0_ = decl_space;
			...
			if (_tmp221_ != NULL) {
				...
				if (_tmp227_ != NULL) {
					...
					if (_tmp238_ != NULL) {
						...
						ValaObjectTypeSymbol* _tmp251_;
						ValaObjectType* _tmp252_;
						ValaObjectType* this_type;
						ValaObjectType* _tmp253_;
						gchar* _tmp254_ = NULL;
						gchar* _tmp255_;
						...
						if (_tmp317_ != NULL) {
							...
							ValaCCodeFunctionDeclarator* vdeclarator;
							ValaCCodeFunctionDeclarator* _tmp325_;
							ValaCCodeParameter* _tmp326_;
							gboolean _tmp327_;
							ValaProperty* _tmp352_;
							ValaDataType* _tmp353_;
							ValaDataType* _tmp354_;
							ValaArrayType* _tmp355_;
							ValaArrayType* array_type;
							ValaArrayType* _tmp356_;
							ValaCCodeDeclaration* _tmp370_;
							ValaCCodeDeclaration* vdecl;
							ValaCCodeDeclaration* _tmp371_;
							ValaCCodeFunctionDeclarator* _tmp372_;
							ValaCCodeStruct* _tmp373_;
							...
							if (_tmp327_) {
								...
								gchar* _tmp335_;
								gchar* _tmp336_;
								ValaCCodeParameter* _tmp337_;
								ValaCCodeParameter* _tmp338_;
								ValaCCodeParameter* cvalueparam;
								ValaCCodeFunctionDeclarator* _tmp339_;
								...
								ValaCCodeParameter* cvalueparam;
								ValaCCodeFunctionDeclarator* _tmp350_;
							...
							if (_tmp356_ != NULL) {
								{
									...
									dim = 1;
									{
										...
										while (TRUE) {
											gboolean _tmp358_;
											gint _tmp360_;
											ValaArrayType* _tmp361_;
											gint _tmp362_;
											gint _tmp363_;
											ValaCCodeFunctionDeclarator* _tmp364_;
											gint _tmp365_;
											gchar* _tmp366_ = NULL;
											gchar* _tmp367_;
											ValaCCodeParameter* _tmp368_;
