...
static void vala_gasync_module_generate_async_function (ValaGAsyncModule* self, ValaMethod* m) {
	...
	ValaMethod* _tmp234_;
	ValaCCodeBaseModuleEmitContext* _tmp279_;
	ValaMethod* _tmp280_;
	ValaCCodeBaseModuleEmitContext* _tmp316_;
	ValaMethod* _tmp376_;
	gchar* _tmp377_ = NULL;
	gchar* _tmp378_;
	gchar* _tmp379_;
	...
	vala_ccode_base_module_emit_context_push_symbol (_tmp279_, (ValaSymbol*) _tmp280_);
	{
		...
		while (TRUE) {
			...
			ValaParameterDirection _tmp293_;
