...
static void vala_gsignal_module_generate_marshaller (ValaGSignalModule* self, ValaList* params, ValaDataType* return_type) {
	...
	gchar* _tmp39_ = NULL;
	gchar* _tmp40_;
	ValaCCodeFunctionDeclarator* _tmp41_;
	...
	ValaCCodeFunctionDeclarator* _tmp78_;
	...
	ValaCCodeTypeDefinition* _tmp88_;
	...
	gchar* _tmp212_ = NULL;
	gchar* _tmp213_;
	ValaCCodeCastExpression* _tmp214_;
	ValaCCodeCastExpression* _tmp215_;
	ValaCCodeCastExpression* c_assign_rhs;
	...
	n_params = 1;
	{
		...
		while (TRUE) {
			...
			if (_tmp70_) {
				ValaCCodeFunctionDeclarator* _tmp71_;
				gint _tmp72_;
				gchar* _tmp73_ = NULL;
				gchar* _tmp74_;
	...
	i = 1;
	{
		...
		while (TRUE) {
			...
			ValaCCodeBinaryExpression* _tmp293_;
		...
		while (TRUE) {
			...
			if (_tmp180_) {
				...
				if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp204_, VALA_TYPE_POINTER_TYPE)) {
					...
					ValaTypeParameter* _tmp208_;
					ValaTypeParameter* _tmp209_;
					_tmp205_ = param;
...
"GNAL_MATCH_DATA");
	...
	if (_tmp165_) {
		...
		ValaCCodeCastExpression* _tmp173_;
