...
static gint vala_compiler_run (ValaCompiler* self) {
	...
	ValaGDBusServerModule* _tmp190_;
	ValaGDBusServerModule* _tmp191_;
	...
	ValaGenieParser* _tmp217_;
	ValaGenieParser* genie_parser;
	ValaGenieParser* _tmp218_;
	ValaCodeContext* _tmp219_;
	ValaGirParser* _tmp220_;
	ValaGirParser* gir_parser;
	ValaGirParser* _tmp221_;
	...
	ValaCodeGenerator* _tmp291_;
	ValaCodeGenerator* _tmp292_;
	...
	if (_tmp237_ != NULL) {
		ValaCodeWriter* _tmp238_;
		ValaCodeWriter* interface_writer;
		ValaCodeWriter* _tmp239_;
	...
	if (_tmp367_ != NULL) {
		ValaCodeWriter* _tmp368_;
		ValaCodeWriter* interface_writer;
		gboolean _tmp369_ = FALSE;
		const gchar* _tmp370_;
		gboolean _tmp373_;
		ValaCodeWriter* _tmp379_;
	...
	if (_tmp382_ != NULL) {
		...
		gboolean _tmp386_;
		ValaCodeWriter* _tmp388_;
		ValaCodeWriter* interface_writer;
		ValaCodeWriter* _tmp389_;
