...
pkgincludedir = $(includedir)/vala
pkglibdir = $(libdir)/vala
pkglibexecdir = $(libexecdir)/vala
...
pkgdatadir = ${datarootdir}/vala-0.24
ACLOCAL = ${SHELL} /usr/src/vala/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /usr/src/vala/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/vala/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/vala/build-aux/missing automake-1.14
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /usr/src/vala/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
PKG_CONFIG_LIBDIR = 
PKG_CONFIG_PATH = :/usr/X11:/usr/X11R7/lib/pkgconfig/
RANLIB = ranlib
SED = /usr/bin/sed
SET_MAKE = 
SHELL = /bin/sh
...
YACC = bison -y
abs_builddir = /usr/src/vala
abs_srcdir = /usr/src/vala
abs_top_builddir = /usr/src/vala
abs_top_srcdir = /usr/src/vala
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gen_introspect_decl = gen_introspect=${libdir}/vala-0.24/gen-introspect-0.24
...
install_sh = ${SHELL} /usr/src/vala/build-aux/install-sh
...
top_builddir = .
top_srcdir = .
vala_gen_introspect_decl = vala_gen_introspect=${bindir}/vala-gen-introspect-0.24
vapigen_decl = vapigen=${bindir}/vapigen-0.24
...
pkgconfig_DATA = libvala-0.24.pc
...
libvala.pc: $(top_builddir)/config.status $(srcdir)/libvala.pc.in
...
coverage-report: coverage
	...
	genhtml --title "vala 0.23.1" --output-directory $(top_builddir)/coverage $(top_builddir)/lcov.info
#endif
